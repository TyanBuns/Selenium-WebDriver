...
public class LoginTest {
    public static void main(String[] args) {
        ...
        try {
            ...
            password.sendKeys("Vuduong123@");

            // Nhấn nút đăng nhập
            WebElement loginButton = wait.until(ExpectedConditions.elementToBeClickable(By.name("login"))); // Cập nhật selector chính xác cho nút đăng nhập
            loginButton.click();
            ...
            WebElement dashboardElement = wait.until(ExpectedConditions.presenceOfElementLocated(By.cssSelector("div[role='banner']"))); // Thay đổi selector thành một phần tử nổi bật
